...
from network import conv3d_model, conv1d_model
import numpy as np
import pandas as pd
...
log_dir = os.path.join('.', 'log', f'BUAA_{model_type}_{file}_{epochs}_{batch_size}_{lr_index}--{clip_len}_{image_size}_wang')
...
my_model = conv1d_model.Conv1dModel(num_classes=num_classes, clip_len=clip_len, image_size=image_size)
