...
class SplitSession():
    ...
    def __init__(self, csv_path, save_path, cur_len, clip_len=8):
...
if __name__ == '__main__':
    ...
    data_src = os.path.join(root_path, 'BUAA-CST20212', 'application')
    data_dst = os.path.join(root_path, 'BUAA-CST20212', f'application_clip_8')
    if not os.path.exists(data_dst):
        os.mkdir(data_dst)
    spw = SplitSessionWorker(data_src, data_dst)
    spw.run()
