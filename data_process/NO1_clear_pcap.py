...
class PcapDeepClear(object):
    ...
    def run(self) -> None:
        ...
        pr.close()
        pw.close()
        print(f'-> 原文件共有 {packets: 6} 个包, 新文件保存 {saved: 6} 个包 ---- 未保存的包中: DNS寻址相关： {dns_others: 4} \t TCP连接建立过程： {tcp_SAF: 4} ')
...
if __name__ == '__main__':
    ...
    clear_data_path = os.path.join(root_path, 'Clear')
